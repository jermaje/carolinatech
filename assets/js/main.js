/* ==========================================================================
   CAROLINA TECHNICIAN - MAIN APP LOGIC
   (THEME, SERVICES, ZONE CHECKER, ESTIMATOR, MODALS, AND WEB3FORMS HANDLER)
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 2. SERVICE TABS CATEGORY FILTER
  ...
  // 5. DETAILED SERVICE POPUP MODALS
...
// 6. CONTACT FORM SUBMIT HANDLER (Web3Forms)
...
// Expose globally for inline form submittal in index.html
